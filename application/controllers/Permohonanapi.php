...
class Permohonanapi extends REST_Controller{
	...
	public function update_post(){
		...
		$response = $this -> M_permohonan-> update_permohonan(
			$this -> post('id_permohonan'),
			$this -> post('status_lengkap')
		);
		$this ->response($response);
	}

					...
					<thead>
						<tr>
							<td style="vertical-align:middle; text-align:center;cursor:pointer;">
								<a href="<?= base_url(); ?>banner/tambah" class="btn btn-success"> <i class="fas fa-plus"></i></a>
							</td>
							<td colspan="6"></td>
						</tr>
						<tr>
					...
					<tbody>
						...
						foreach ($banner as $bnr) : ?>
							<tr>
								...
								<!-- <td><a target="blank" href="<?= $bnr->link_mitra ?>"><?= $bnr->link_mitra ?></a></td> -->
								<td>
									<a target="blank" href="<?= base_url('assets/backend/img/img_banner/' . $bnr->path_gambar_banner) ?>">
										<img src="<?= base_url('assets/backend/img/img_banner/' . $bnr->path_gambar_banner) ?>" alt="Photo Image" width="100%">
									</a>
								</td>
								...
								<td>
									<center>
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="<?= base_url(); ?>banner/updateData/<?= $bnr->id_banner ?>" onclick="return confirm('Apakah anda yakin akan mengubahnya?');"><i class="fas fa-edit"></i> Ubah</a>
											<a class="dropdown-item" href="<?= base_url(); ?>banner/deleteData/<?= $bnr->id_banner ?>" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class="fas fa-trash"></i> Hapus</a>
										</div>
									</center>
								</td>
							</tr>

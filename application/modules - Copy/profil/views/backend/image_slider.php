...
function save(){
  ...
  var formData = new FormData(form);
	...
	url = "<?php echo site_url('profil/ajax_upload_image_slider')?>";
	Swal.fire({
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manajemen Image Slide PPID</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>"">Home</a></li>
              <li class="breadcrumb-item active">Image Slide PPID</li>
            </ol>
          </div>
        </div>
      </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input data-val="1" class="priviw custom-file-input" accept="image/*" type="file" id="imgInp1" name="foto[]">
		...
		<div class="card-body">
			<div class="row">
				...
				<div class="col-lg-3 col-md-4 col-6">
					<button type="button" onclick='del("<?= $row->image?>")' class="btn btn-danger btn-sm btn-block"><i class="fas fa-fw fa-trash"></i></button>
					<a href="javascript:void(0)" onclick="magnify('<?= $row->image ?>')" class="d-block mb-4 h-100">
						<img class="img-fluid img-responsive img-thumbnail" src="<?php echo base_url('assets/media/image/').$row->image ?>" alt="">
					</a>
				</div>
				<?php } ?>

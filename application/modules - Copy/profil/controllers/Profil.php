...
class Profil extends MX_Controller
{
	...
	// 		$_FILES['upload_File']['name'] = $_FILES['foto']['name'];
	// 		$_FILES['upload_File']['type'] = $_FILES['foto']['type'];
	// 		$_FILES['upload_File']['tmp_name'] = $_FILES['foto']['tmp_name'];
	// 		$_FILES['upload_File']['error'] = $_FILES['foto']['error'];
	// 		$_FILES['upload_File']['size'] = $_FILES['foto']['size'];
	...
	// 				'option' => $opt,
	// 			);
	// 			// echo $uploadPath . $fileData['file_name'];
	// 			// die();
	// 			$this->watermark($uploadPath . $fileData['file_name']);
	...
	// public function watermark($uploadPath)
	// {
	// 	$this->load->library('image_lib');

	// 	$config['source_image'] = $uploadPath;
	// 	$config['wm_text'] = 'Copyright 2021 - Dinas Kesehatan';
	// 	$config['wm_type'] = 'text';
	// 	$config['wm_font_path'] = base_url("assets/font/Amiri-Bold.ttf");
	...
	// 	$this->image_lib->initialize('image_lib', $config);

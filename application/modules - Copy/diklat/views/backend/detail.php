                    ...
                    <?php foreach ($t_diklat as $a) : ?>
                        <form action="<?php echo base_url() . 'diklat/updateDataAksi' ?>" method="post" enctype="multipart/form-data" id="updateBerita">
                            ...
                            <div class=" form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama_diklat" name="nama_diklat" value="<?= $a->nama_diklat, set_value('nama_diklat') ?>" autocomplete="off" disabled>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <a target="blank" href="<?= base_url('assets/backend/img/img_diklat/' . $k["path_foto_diklat"]) ?>">
                                                                        <img src="<?= base_url('assets/backend/img/img_diklat/' . $k["path_foto_diklat"]) ?>" width="50%">
                                                                    </a>
                                                                <?php
                                                                } else { ?>
                                                                    <a href="javascript:void(0)">
                                                                        <img src="<?= base_url('assets/backend/img/not-found.jpg'); ?>" alt="" width="50%">
                                                                    </a>
                                                                <?php } ?>
                                                            </td>
                                                            <!-- <td></?= $k["ket_foto"] ?></td> -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="isi_diklat" disabled id="isi_diklat"><?= $a->isi_diklat, set_value('isi_diklat') ?></textarea>

...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Manajemen Informasi Pengadaan</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<!-- <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>"">Home</a></li> -->
					<li class="breadcrumb-item active">Informasi Pengadaan</li>
				</ol>
			</div>
		</div>
	</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-file form-group">
										...
										<span style="font-style: italic; color:red;">*) File Harus Berformat pdf.</span>
									</div>
									<div class="form-link form-group">
										<label for=""> Link</label>
										<input type="url" name="link" id="link" class="form-control" link required></input>
										<span style="font-style: italic; color:red;">*) Contoh Pengisian : https://sirup.lkpp.go.id/sirup/ro/penyedia/kldi/D43.</span><br>
									</div>
									<!-- adun close -->
								</div>
							</div>

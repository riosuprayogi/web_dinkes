            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php foreach ($t_berita as $a) : ?>
                        <form action="<?php echo base_url() . 'berita/updateDataAksi' ?>" method="post" enctype="multipart/form-data" id="updateArtikel">
                                    ...
                                    <div class="col-sm">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <input type="hidden" class="form-control" name="id_detail_path_foto_berita_update[]" value="<?= $k["id_foto_berita"]; ?>">
                                                            <td><?= $k["urutan"] ?></td>
                                                            <td>

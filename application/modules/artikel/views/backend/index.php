...
function edit(id){
	...
	//Ajax Load data from ajax
	$.ajax({ url : "<?php echo site_url('dasar_hukum/ajax_edit/')?>/" + id,
		type: "GET",
		dataType: "JSON",
		async: false,
		success: function(data){
...
function del(id){
	Swal.fire({
		...
		if (result.value) {
			$.ajax({ url : "<?php echo site_url('dasar_hukum/ajax_delete')?>/"+id,
				type: "GET",
				dataType: "JSON",
				async: false,
				success: function(data){
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<input id="dasar_hukum" accept="image/jpeg,image/gif,image/png,application/pdf" name="dasar_hukum"
											type="file" class="file" data-show-caption="true">

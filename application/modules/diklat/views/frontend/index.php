            ...
            <!-- <div class="" data-flickity='{ "wrapAround": true,  "pageDots": false }'> -->
                ...
                // $string .= '... <a href="/this/story">Read More</a>';
                    ...
                    <div class="col-md-4 col-sm-4    ">
                        <div class="" style=" overflow: hidden;   padding: 10px; border-radius: 10px;">
                            <div class="" style="width: 16.5rem; height: 650px; overflow: hidden; background-color: transparent; ">
                                  ...
                                  <div class="card-body" >
                                    ...
                                    <p>
                                        ...
                                        <span><br><br>
                                            ...
                                            <a style="margin-top: 40px; margin-bottom: 10px; float: right" href="<?= base_url('site/detail/' . $f["id_diklat"]) ?>">Baca Selanjutnya</a>

                    ...
                    <?php foreach ($t_berita as $a) : ?>
                        <form action="<?php echo base_url() . 'berita/updateDataAksi' ?>" method="post" enctype="multipart/form-data" id="updateBerita">
                            ...
                            <div class=" form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="judul_berita" name="judul_berita" value="<?= $a->judul_berita, set_value('judul_berita') ?>" disabled autocomplete="off">
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" style="width: 3%;">Foto</th>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <a target="blank" href="<?= base_url('assets/backend/img/img_berita/' . $k["path_foto_artikel"]) ?>">
                                                                        <img src="<?= base_url('assets/backend/img/img_berita/' . $k["path_foto_artikel"]) ?>" alt="<?= $k["ket_foto"]; ?>" width="50%">
                                                                    </a>
                                                                <?php
                                                                } else { ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="isi_berita" disabled id="isi_berita"><?= $a->isi_berita, set_value('isi_berita') ?></textarea>

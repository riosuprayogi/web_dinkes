					...
					<thead>
						<tr>
							<td style="vertical-align:middle; text-align:center;cursor:pointer;">
								<a href="<?= base_url(); ?>link_terkait/tambah" class="btn btn-success"> <i class="fas fa-plus"></i></a>
							</td>
							<td colspan="6"></td>
						</tr>
						<tr>
								...
								<td>
									<center>
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="<?= base_url(); ?>link_terkait/updateData/<?= $mtr->id_mitra ?>" onclick="return confirm('Apakah anda yakin akan mengubahnya?');"><i class="fas fa-edit"></i> Ubah</a>
											<a class="dropdown-item" href="<?= base_url(); ?>link_terkait/deleteData/<?= $mtr->id_mitra ?>" onclick="return confirm('Apakah anda yakin akan menghapusnya?');"><i class="fas fa-trash"></i> Hapus</a>
										</div>
									</center>
								</td>
							</tr>

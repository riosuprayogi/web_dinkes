...
function tree(data,select=null)
	...
	function get_data_jenis(id){
		$.ajax({ url : "<?php echo site_url('ir_Rka/get_data_jenis/')?>"+id,
		type: "GET",
		dataType: "JSON",
		async: false,
...
$(document).ready(function() {
	...
	$('#tt').treegrid({
					...
					columns:[[
						...
						{field:'deskripsi',title:'Deskripsi',width:480,
							styler: function(value,row,index){
							if (value < 20){
								// return 'background-color:#ffee00;color:red;';
						...
						// 	}
						// }},
						{field:'file',title:'FILE',styler: function(value,row,index){
							if (value < 20){
								// return 'background-color:#ffee00;color:red;';
								return 'min-width:100px';
								// the function can return predefined css class and inline style
...
function add(){
	...
	$.ajax({ url : "<?php echo site_url('ir_Rka/ajax_add/')?>",
		type: "GET",
		dataType: "JSON",
		async: false,
		success: function(data){
...
function edit_jenis(id){
	...
	//Ajax Load data from ajax
	$.ajax({ url : "<?php echo site_url('ir_Rka/ajax_edit_jenis/')?>/"+id,
		type: "GET",
		dataType: "JSON",
		async: false,
		success: function(data){
...
function add_parent(id){
	...
	$('.help-block').empty(); // clear error string
	if(id != 0){
		var url = "<?php echo site_url('ir_Rka/ajax_edit_parent/')?>"+id;
		
	}else{
		var url = "<?php echo site_url('ir_Rka/ajax_add/')?>"
	}
	//Ajax Load data from ajax
	$.ajax({ url : url,
		type: "GET",
...
function edit_parent(id){
	...
	//Ajax Load data from ajax
	$.ajax({ url : "<?php echo site_url('dokumen/ajax_edit_parent/')?>/"+id,
		type: "GET",
		dataType: "JSON",
		async: false,
		success: function(data){
...
function del_file(id){
	$.ajax({ url : "<?php echo site_url('informasi_rencana/ajax_delete_file/');?>/"+id,
		type: "POST",
		dataType: "JSON",
		success: function(data){
			location.reload();
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Informasi Rencana</h1>
          </div>
          <div class="col-sm-6">

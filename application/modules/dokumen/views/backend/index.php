...
function tree(data,select=null)
	...
	function get_data_jenis(id){
		$.ajax({ url : "<?php echo site_url('dokumen/get_data_jenis/')?>"+id,
		type: "GET",
		dataType: "JSON",
		async: false,
...
function add(){
	...
	$.ajax({ url : "<?php echo site_url('dokumen/ajax_add/')?>",
		type: "GET",
		dataType: "JSON",
		async: false,
		success: function(data){
...
function edit_jenis(id){
	...
	//Ajax Load data from ajax
	$.ajax({ url : "<?php echo site_url('dokumen/ajax_edit_jenis/')?>/"+id,
		type: "GET",
		dataType: "JSON",
		async: false,
		success: function(data){
...
function del_file(id){
	$.ajax({ url : "<?php echo site_url('dokumen/ajax_delete_file/');?>/"+id,
		type: "POST",
		dataType: "JSON",
		success: function(data){
			location.reload();
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manajemen Dokumen Informasi</h1>
          </div>
          <div class="col-sm-6">

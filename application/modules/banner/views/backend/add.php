    ...
    <div class="row mr-auto">
        <div class="col-md">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo base_url() . 'banner/action_add'; ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                        <div class="form-group row">
                            <label for="nama_banner" class="col-sm-2 col-form-label">Nama Banner</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nama_banner" name="nama_banner" value="<?= set_value('nama_banner'); ?>" autocomplete="off">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2" for="path_gambar_banner">Gambar</div>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-4">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="custom-file">
                                            <div class="col-sm-8">
                                                ...
                                                <input type="file" class="custom-file-input" id="customFileUpload" name="path_gambar_banner" style="display: none;">
                                                <span style="font-style: italic; color:red;">*) Format Gambar (jpg,jpeg,png) ukuran file max 2 Mb.</span><br>

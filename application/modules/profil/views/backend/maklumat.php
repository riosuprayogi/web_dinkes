...
function del(id) {
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
                url: "<?php echo site_url('profil/ajax_delete_foto?link=')?>" + id,
                type: "POST",
                dataType: "JSON",
                async: false,
                success: function (data) {
					    ...
					    <div class="row">
					        <div class="col-md-8">
					            ...
					            <div class="input-group">
					                <div id="form_foto" class="custom-file">
					                    <input data-val="1" class="priviw custom-file-input" accept="image/*" type="file" id="imgInp1"
					                        name="foto[]">
					        ...
					        <div class="col-md-4">
					            <div style=" margin: auto;width: fit-content; padding: 10px;">
					                ...
					                <img data-val="1" id="blah1" class="blah" src=""
					                    style="max-width:400px; margin: auto; padding: 10px;" />
					            </div>
					        </div>
					    </div>
					    <br>

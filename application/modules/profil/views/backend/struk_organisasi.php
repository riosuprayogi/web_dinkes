...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Management Struktur Organisasi</h1>
            </div>
            <div class="col-sm-6">
...
<section class="content">
    <div class="card">
        <form action="#" id="form1" class="form-horizontal">
            <div class="card-body">
                <input type="hidden" value="struk_organisasi" id="option" name="option">
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <?php if (count($profil) < 1) { ?>
                    <div class="form-group">
                        <label for="exampleInputFile">File input Struktur Organisasi</label>
                        <div class="row">
                            <div class="col-md-8">

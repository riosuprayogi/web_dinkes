...
function save(){
	...
	Swal.fire({
      ...
      text: "Apa Anda Yakin Menyimpan Data Maklumat?",
      icon: 'warning',
      ...
      if (result.value) {
        ...
        url = "<?php echo site_url('profil/ajax_insert_maklumat')?>";
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manajemen Maklumat PPID</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>"">Home</a></li>
              <li class="breadcrumb-item active">Maklumat PPID</li>
            </ol>
          </div>
        </div>
      </div>
...
<section class="content">
	<div class="card">
		<form action="#" id="form1" class="form-horizontal">
			<!-- <div class="card-body">
				<input type="hidden" value="maklumat" id="option" name="option">
				<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
				<textarea class="textarea" name="isi" id="isi" placeholder="Place some text here" style="width: 100%; min-height: 700px !important;  font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo htmlentities($isi); ?></textarea>
      </div> -->
      ...
      function uploadImage(image) {
        ...
        $.ajax({
            ...
            success: function(url) {
                ...
                $('.textarea').summernote('code', html + '<img style="width: 100%" src="' + url + '"/>'); 
            },
            error: function(data) {
                console.log(data);
            }

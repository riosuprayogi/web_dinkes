...
<head>
	...
	<title>DinKes Kota Tangerang</title>

	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/web/assets/mobirise-icons/mobirise-icons.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/bootstrap/css/bootstrap.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/bootstrap/css/bootstrap-grid.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/bootstrap/css/bootstrap-reboot.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/socicon/css/styles.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/dropdown/css/style.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/tether/tether.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/theme/css/style.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/css/home.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/css/fa.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/css/swiper.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/css/owl.carousel.min.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/css/font-awesome.css">
	<link rel="preload" as="style" href="<?php echo base_url(); ?>assets/tangerangkota/mobirise/css/mbr-additional.css">
	<link rel="stylesheet" href="<?php echo base_url(); ?>assets/tangerangkota/mobirise/css/mbr-additional.css" type="text/css">
	...
	<!--galery-->
	<!-- <script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/jquery-11.0.min.js'></script>	

		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-common-libraries.js'></script>	
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-functions.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-thumbsgeneral.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-thumbsstrip.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-touchthumbs.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-panelsbase.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-strippanel.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-gridpanel.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-thumbsgrid.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-tiles.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-tiledesign.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-avia.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-slider.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-sliderassets.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-touchslider.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-zoomslider.js'></script>	
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-video.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-gallery.js'></script>
		<script type='text/javascript' src='<?php echo base_url(); ?>assets/tangerangkota/unitegallery/js/ug-lightbox.js'></script>
    				...
    				<ul class="navbar-nav text-uppercase ml-auto">
    					...
    					<li class="nav-item dropdown">
    						...
    						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
    							<a class="dropdown-item" href="<?= base_url('profil_opd') ?>">Profil</a>
	...
	<section class="cid-rKNAWQjciZ" id="footer1-9">
		<div class="container">
			...
			<div class="media-container-row content text-white">
				...
				<div class="align-center">
					...
					<p class="mbr-text mbr-fonts-style display-9">
						Situs Resmi Dinas Kesehatan Kota Tangerang
						<br>Jl Raya Daan Mogot No. 69 Kel. Sukasari Kec. Tangerang 15111<br>
					</p>

					<div class="social-list align-right">
						<div class="soc-item">
							<a href="#" target="_blank">
								<span class="socicon-googlemaps socicon mbr-iconfont mbr-iconfont-social"></span>
							</a>
						</div>
					</div>
				</div>
				...
				<div class="media-container-row mbr-white">
					<div class="col-sm-6 copyright">
						<p class="mbr-text mbr-fonts-style display-7">
							© Copyright <?= date('Y'); ?> - <a href="https://diskominfo.tangerangkota.go.id/" target="_blank">Dinas Komunikasi dan Informatika Kota Tangerang</a>
						</p>
					</div>
					<div class="col-md-6">
						<!-- <div class="social-list align-right">

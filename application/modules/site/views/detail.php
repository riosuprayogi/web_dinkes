...
<!-- <style>
  ...
  <!--   <section data-aos="fade-right" style="text-align: center">
                            ...
                            <?php foreach ($sliderbanner as $f) : ?>
                                ...
                                <?php if (count($f["path_foto_artikel"]) > 0) {
                                    foreach ($f["path_foto_artikel"] as $k) {
                                      ...
                                      <img style=" margin:auto; background-size: cover; background-position: center; width: 100% " src="<?= base_url('assets/backend/img/img_berita/' . $k["path_foto_artikel"]) ?>"   height="600px" width="100%">
                                      <?php
                                  }
                              } ?>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="carousel" data-flickity='{ "wrapAround": true, "autoPlay":2500,  "pageDots": false, "pauseAutoPlayOnHover": false }'>
                    ...
                    <?php foreach ($sliderdetailberita as $f) : ?>
                        ...
                        <?php if (count($f["path_foto_artikel"]) > 0) {
                            foreach ($f["path_foto_artikel"] as $k) {
                              ...
                              <img style=" margin:auto; background-size: cover; background-position: center; width: 100% " src="<?= base_url('assets/backend/img/img_berita/' . $k["path_foto_artikel"]) ?>"   height="500px" width="100%">
                              <?php
                          }
                      } ?>
...
<!-- <div class="col-md-12"> -->
    ...
    <!-- <section  id="icon-formulir"   data-aos="fade-right" style=" height: 100%">
        <div class="container">
            <div class="">
                ...
                <div class="" data-flickity='{ "wrapAround": true, "pageDots": false }'>
                    <?php foreach ($berita4 as $f) :

                        ?>
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="img-responsive  " style="width: 100%; height: 370px; overflow: hidden; background-color: white;">
                                <a href="<?= base_url('site/detail/' . $f["id_berita"]) ?>" style="text-decoration: none; color: #000000; height: 30%">
                                 <?php if (count($f["path_foto_artikel"]) > 0) {
                                    foreach ($f["path_foto_artikel"] as $k) {
                                      ?>
                                      <img class="cv" src="<?= base_url('assets/backend/img/img_berita/' . $k["path_foto_artikel"]) ?>"   height="250px" width="100%">
                                      <?php
                                  }
                              } ?>
                              <div class="card-body">
                                <center> <b class="cv"><?= $f["judul_berita"] ?></b></center>
                            </div>
                        </a>
                        <span><br><br>
                        </span>
     ...
     <div class="row">
        <div class="col-md-12" >
            <div class="card-img" style="">
                <img class="logo-video2" src="<?php echo base_url(); ?>assets/media/image/artikel_terkait.png" alt="" style="padding-bottom: 10px;">
            </div>
        </div>
    </div>
    <div class="container info" >

        ...
        <div class="col-md">
            <div class="card">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold text-primary">INPUT DATA MITRA</h6>
                </div>
                <div class="card-body">
                    <form action="<?php echo base_url() . 'mitra/action_add'; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="link_mitra" class="col-sm-2 col-form-label">Link Web Mitra</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-2" for="path_gambar_mitra">Foto Mitra</div>
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-4">
                        ...
                        <a href="<?= base_url(); ?>mitra" class="btn btn-primary ml-3">Kembali</a>
                        <br>
                        <br>
                    </form>
                </div>

...
<!-- <div style="background-image: url('<?= base_url('assets/img/banner/5.png') ?>') ; height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;"> -->
	<div style="background-image: url('<?= base_url('assets/media/image/bgdinkeswh.png') ?>') ; height: 100%; background-position: right; background-repeat: no-repeat; background-size: cover; width: 100%">
...
<!-- <div style="background-image: url('<?= base_url('assets/img/banner/5.png') ?>') ; height: 100%; background-position: center; background-repeat: no-repeat; background-size: cover;"> -->
	<div style="background-image: url('<?= base_url('assets/media/image/bgdinkesblue.png') ?>') ; height: 100%; background-position: right; background-repeat: no-repeat; background-size: cover; width: 100%">

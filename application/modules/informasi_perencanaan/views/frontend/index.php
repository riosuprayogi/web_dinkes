...
<section id="icon-formulir" class="cid-icon-formulir" data-rv-view="1620">
	<div class="container">		
		...
		<!-- <div class="media-container-row ">
			<div class="row align-left">
				<div class="col-md-6 ">
					<a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(7)">
						<div class="card">
							<div class="card-horizontal">
								<div class="img-square-wrapper">
									<img class="icon" src="<?php echo base_url();?>assets/img/icon/icon-15.png" alt="Card image cap">
								</div>
								<div class="card-body">
									<h4 class="card-title">Informasi Hukum dan Pemerintahan</h4>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-6 ">
					<a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(11)">
						<div class="card">
							<div class="card-horizontal">
								<div class="img-square-wrapper">
									<img class="icon" src="<?php echo base_url();?>assets/img/icon/icon-14.png" alt="Card image cap">
								</div>
								<div class="card-body">
									<h4 class="card-title">Informasi Laporan Kinerja</h4>
								</div>
							</div>
						</div>
					</a>
		...
		<!-- <div class="media-container-row ">
			<div class="row align-left">
				<div class="col-md-6 ">
					<a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(8)">
						<div class="card">
							<div class="card-horizontal">
								<div class="img-square-wrapper">
									<img class="icon" src="<?php echo base_url();?>assets/img/icon/icon-16.png" alt="Card image cap">
								</div>
								<div class="card-body">
									<h4 class="card-title">Informasi Kepegawaian, Pendidikan dan Pelatihan</h4>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-6 ">
					<a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(12)">
						<div class="card">
							<div class="card-horizontal">
								<div class="img-square-wrapper">
									<img class="icon" src="<?php echo base_url();?>assets/img/icon/icon-17.png" alt="Card image cap">
								</div>
								<div class="card-body">
									<h4 class="card-title">Data Informasi Statistik dan Publikasi</h4>
								</div>
							</div>
						</div>
					</a>
					...
					<!-- <a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(100)">
						<div class="card">
							<div class="card-horizontal">
								...
								<div class="card-body">
									<h4 class="card-title">Data dan Dokumen Pelayanan Informasi Publik</h4>
								</div>
							</div>
						</div>
					</a> -->
			...
			<div class="col-md-6">
				<a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(1)">
					<div class="card">
						<div class="card-horizontal">
							<div class="img-square-wrapper">
								<img class="icon" src="<?php echo base_url();?>assets/img/icon/icon-06.png"
									alt="Card image cap">
							</div>
							<div class="card-body">
			...
			<div class="col-md-6">
				<a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(2)">
					<div class="card">
						<div class="card-horizontal">
							<div class="img-square-wrapper">
								<img class="icon" src="<?php echo base_url();?>assets/img/icon/icon-09.png"
									alt="Card image cap">
							</div>
							<div class="card-body">
					...
					<a class="text-dark js-scroll-trigger" href="#dokumen" onclick="link_dokumen(4)">
						<div class="card">
							<div class="card-horizontal">
								...
								<div class="card-body">
									<h4 class="card-title">Daftar Informasi dan Dokumentasi Publik (DIDP)</h4>
								</div>
							</div>
						</div>
					</a>
...
<section id="dokumen" data-rv-view="1620" style="display:none; overflow: auto; padding-top: 50%;position: relative;">

...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Manajemen Mitra Kerja</h1>
			</div>
			<div class="col-sm-6">
					...
					<thead>
						<tr>
							<td style="vertical-align:middle; text-align:center;cursor:pointer;">
								<a href="<?= base_url(); ?>mitra/tambah" class="btn btn-success"> <i class="fas fa-plus"></i></a>
							</td>
							<td colspan="6"></td>
						</tr>
						<tr>
					...
					<tbody>
						...
						foreach ($mitra as $mtr) : ?>
							<tr>
								...
								<td><a target="blank" href="<?= $mtr->link_mitra ?>"><?= $mtr->link_mitra ?></a></td>
								<td>
									<a target="blank" href="<?= base_url('assets/backend/img/img_mitra/' . $mtr->path_gambar_mitra) ?>">
										<img src="<?= base_url('assets/backend/img/img_mitra/' . $mtr->path_gambar_mitra) ?>" alt="Photo Image" width="100%">
									</a>
								</td>

								<td><?= $mtr->status ?></td>
								<td><?= date('d-M-Y H:i:s', strtotime($mtr->tgl_jam)); ?></td>
								<td>
									<center>
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="<?= base_url(); ?>mitra/edit/<?= $mtr->id_mitra ?>" onclick="return confirm('Apakah anda yakin akan mengedit nya?');"><i class="fas fa-edit"></i> Ubah</a>
											<a class="dropdown-item" href="<?= base_url(); ?>mitra/ajax_delete/<?= $mtr->id_mitra ?>" onclick="return confirm('Apakah anda yakin akan menghapus nya?');"><i class="fas fa-trash"></i> Hapus</a>
										</div>
									</center>
								</td>
							</tr>

...
function save(){
  ...
  var formData = new FormData(form);
	...
	Swal.fire({
      ...
      text: "Apa Anda Yakin Mengupload Data Kepwal Ini?",
      icon: 'warning',
...
function del(id){
	Swal.fire({
      title: 'Apa Anda Yakin?',
      text: "Apa Anda Yakin Menghapus Data Kepwal Ini?",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
...
<div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Manajemen Kepwal PPID</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url();?>"">Home</a></li>
              <li class="breadcrumb-item active">Kepwal PPID</li>
            </ol>
          </div>
        </div>
      </div>
...
<section class="content">
	<div class="card">
		<form action="#" id="form1" class="form-horizontal">
			<div class="card-body">
        <input type="hidden" value="kepwal" id="option" name="option">
				<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
        <?php if(count(@$kepwal) < 1) {?>
                    <div class="form-group">
                        <label for="">Berkas</label>
                        <input id="dasar_hukum" accept="image/jpeg,image/gif,image/png,application/pdf"  name="foto[]" type="file" class="file" data-show-caption="true">
		...
		<div class="card-body">
			<div class="row align-center">
				...
				<div class="col-lg-2 col-md-2 col-6">
					...
					<a href="<?php echo base_url('assets/media/image/').$row->isi ?>" target="_blank"  class="d-block mb-4 h-100">
						<img class="img-fluid img-responsive img-thumbnail" style="width:100%; margin:auto;" src="https://img.icons8.com/fluent/48/000000/file.png"alt="">
					</a>
				</div>
				<?php } ?>
